...
(use-package bufferlo
  ...
  (bufferlo-mode t)
  (tab-bar-mode t)
  ;; Create a local scratch buffer for each tab:
  ;;(setq tab-bar-new-tab-choice #'bufferlo-create-local-scratch-buffer)
  ;; Create a new local scratch buffer for new frames:
...
(use-package vterm
  ...
  :ensure (:host github :repo "kiennq/emacs-libvterm"))
